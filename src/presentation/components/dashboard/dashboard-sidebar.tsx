...
import type { AdminPermissions } from "@/presentation/data/account-mock-data";
import {
  filterNavItems,
  primaryNavConfig,
  secondaryNavConfig,
...
const navIcons: Record<string, React.ComponentType<{ className?: string }>> = {
  "/dashboard": GridIcon,
  "/dashboard/orders": OrderIcon,
  "/dashboard/transactions": TransactionIcon,
  "/dashboard/services": ServiceIcon,
  "/dashboard/account": AccountIcon,
  "/dashboard/settings": SettingsIcon,
  "/dashboard/notifications": BellIcon,
  "/dashboard/help": HelpIcon,
  "/dashboard/tickets": TicketIcon,
};

function buildNavItems(
  config: typeof primaryNavConfig,
  permissions: AdminPermissions,
): NavItem[] {
  return filterNavItems(config, permissions).map((item) => ({
    ...item,
    icon: navIcons[item.href] ?? GridIcon,
  }));
}
...
function SidebarPanel({
  ...
  const primaryNav = useMemo(
    () => buildNavItems(primaryNavConfig, permissions),
    [permissions],
  );
  const secondaryNav = useMemo(
    () => buildNavItems(secondaryNavConfig, permissions),
    [permissions],
  );
